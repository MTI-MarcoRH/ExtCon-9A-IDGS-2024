...
CREATE DEFINER=Juan.cruz@localhost PROCEDURE sp_insertar_estudios(IN cantidad_estudios INT)
BEGIN
    ...
    solicitud_loop: LOOP
        ...
        IF done OR contador >= cantidad_estudios THEN
            LEAVE solicitud_loop;  -- Salir del loop cuando no haya más solicitudes o se haya alcanzado la cantidad deseada
        END IF;
